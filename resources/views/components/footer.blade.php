<footer class="footer bg-primary fixed-bottom mt-2">
    <div class="container d-flex p-4">
        <div class="row">
            <div class="col-12">
                <p>For more information please go to <a class="text-white" href="https://www.themoviedb.org/">The Movie Database</a> and special thanks.</p>
